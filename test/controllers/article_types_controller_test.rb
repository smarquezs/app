...
class ArticleTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create article_type" do
    assert_difference('ArticleType.count') do
      post article_types_url, params: { article_type: { description: @article_type.description, name: @article_type.name } }
    end
  ...
  test "should update article_type" do
    patch article_type_url(@article_type), params: { article_type: { description: @article_type.description, name: @article_type.name } }
